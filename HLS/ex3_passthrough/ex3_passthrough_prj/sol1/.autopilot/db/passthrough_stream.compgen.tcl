...
if {${::AESL::PGuard_simmodel_gen}} {
	if {[info proc ::AESL_LIB_XILADAPTER::s_axilite_gen] == "::AESL_LIB_XILADAPTER::s_axilite_gen"} {
		eval "::AESL_LIB_XILADAPTER::s_axilite_gen { \
			id 1 \
			corename passthrough_stream_ctrl_axilite \
			name passthrough_stream_ctrl_s_axi \
			ports {$port_ctrl} \
			op interface \
...
if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler passthrough_stream_ctrl_s_axi BINDTYPE interface TYPE interface_s_axilite
}
...
# RegSlice definition:
set ID 10
set RegSliceName passthrough_stream_regslice_both
set RegSliceInstName passthrough_stream_regslice_both_U
set CoreName ap_simcore_passthrough_stream_regslice_both
if {${::AESL::PGuard_rtl_comp_handler}} {
